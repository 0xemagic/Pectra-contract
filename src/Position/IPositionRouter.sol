...
interface IPositionRouter {
     ...
     */
    function getRequestQueueLengths() external view returns (uint256 _increaseStart, uint256 _maxIncreasePositions, uint256 _decreaseStart, uint256 _maxDecreasePositions);
}
