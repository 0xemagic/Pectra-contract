...
const PectraTeam = () => {
  ...
  const teamMembers = [
    {
      ...
      links: [
        {
          url: "https://twitter.com/hufhaus9",
          icon: (
            <RiTwitterFill
    ...
    },
    {
      ...
      links: [
        {
          url: "https://twitter.com/mathdroid",
          icon: (
            <RiTwitterFill
              color={colorMode === "dark" ? "#FFFFFF" : "#222222"}
              size="32px"
    ...
    },
    {
      ...
      links: [
        {
          url: "https://twitter.com/pray4profit",
          icon: (
            <RiTwitterFill
              color={colorMode === "dark" ? "#FFFFFF" : "#222222"}
              size="32px"
  ...
  return (
    <Flex w="100%" direction="column" alignItems="center" pt="10rem">
      <Flex mb="5rem">
        {" "}
        <Heading variant="colored" color="brand" mr="0.5rem" mb={4}>
          Pectra
        </Heading>
      ...
      >
        {teamMembers.map((member, index) => (
          <Flex key={index} direction="column" alignItems="center" mb={10}>
            <Circle
              size="120px"
              bg="gray.200"
