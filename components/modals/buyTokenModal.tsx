...
import { useBuyTokens, useWatchApprove } from "../hooks/usePublicSale";
...
export default function BuyTokenModal({ isOpen, onClose }: any) {
  ...
  const { isApproved } = useWatchApprove(address!, amount);
  ...
  const insufficientBalance =
    usdcBalance && +formatUnits(usdcBalance!.value!, 6) < +amount!;
                    ...
                    <>
                      ...
                      >
                        ...
                        <Flex
                          w="100%"
                          justifyContent={
                            insufficientBalance ? "space-between" : "end"
                          }
                        >
                          {insufficientBalance && (
                            <Text ml="1.25rem" variant="paragraph" color="red">
                          ...
                          >
                            ...
                            <b>
                              {usdcBalance
                                ? truncate(
                                    usdcBalance!.formatted!.toString(),
                                    2
                                  )
                                : 0}
                            </b>{" "}
              ...
              {address !== undefined ? (
                <>
                  <Button
                    ...
                    mr={3}
                    disabled={
                      (step === 2 && amount === "0") || isLoadingApprove
                      // || isApproved
                    }
                    onClick={
                      step === 1
